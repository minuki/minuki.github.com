...
function getClienLegoDB(number, mode){
	...
	// Define Table Placeholder
		...
		html += '</tr>';
                ...
                if (rrpKRChange != "" && rrpKRChange != undefined){
                html += '<tr>';
	        html += '<td></td>';
	        html += '<td></td>';
		...
		linkHtml = "<p><a href='http://shop.lego.com/ko-KR/product/?p=" + modelNumber + "' target='_blank'>-> View at Shop@Home Korea</a></p>";
		linkHtml += "<p><a href='http://brickset.com/detail/?set=" + fullModelNumber + "' target='_blank'>-> View at brickset.com</a></p>";
